...
<script>
 ...
 export default {
     ...
     created() {
         ...
         let apiURL = 'http://172.26.54.21:8082/api/classStatus';
     ...
     methods :{
         ...
         saveBt(id,t) {
             ...
             let apiURL = `http://172.26.54.21:8082/api/classStatus/${t.ClassStatusID}`;
         ...
         if (classStatus.Status){
           let apiURL = `http://172.26.54.21:8082/api/classStatus/`;
       await axios.post(apiURL,classStatus).catch(error => {
           console.log(error)
       });
       this.$router.go()
         }
